...
**18 jobs, todos con plano verificado.**
...
**67 ficheros** de producción usan `user_key` (lista congelada: 64; solo puede decrecer).
...
| GET | `/api/v1/feedback/asistente/peores` |
| GET | `/api/v1/feedback/asistente/resumen` |
