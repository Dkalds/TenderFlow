"""v114: maestro de órganos de contratación (C1.2, ADR-032, D22).
...
Riesgo
------
Ninguno por sí sola: crea tablas vacías. El riesgo vive en ``v115``, que añade
...
revision: str = "v114_organos_master"
down_revision: str | Sequence[str] | None = "v113_lic_semantica_del_importe"
