"""v120: el chunk dice de qué modelo es su embedding y de qué página sale (C5.7, C5.3).
...
mismo error que ``importe_tipo`` evitó en v113 al dejar el histórico en
...
revision: str = "v120_documento_chunks_version_pagina"
down_revision: str | Sequence[str] | None = "v119_webhook_deliveries_reintento"
