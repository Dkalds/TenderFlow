"""v116: ``api_keys.organization_id`` — claves de equipo, no solo personales (C2.3, D25).
...
revision: str = "v116_api_keys_organizacion"
down_revision: str | Sequence[str] | None = "v115_lic_organo_id"
