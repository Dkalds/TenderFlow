"""v123: nota en el favorito y menciones del comentario (C6.6, C6.2).

Revision ID: v123_notas_y_menciones
Revises: v122_go_no_go
...
revision: str = "v123_notas_y_menciones"
down_revision: str | Sequence[str] | None = "v122_go_no_go"
