"""v126: el diccionario de tecnologías deja de ser un deploy (C5.6, D28).

Revision ID: v126_tecnologias_keywords
Revises: v125_retirar_extracciones
...
down_revision: str | Sequence[str] | None = "v125_retirar_extracciones"
