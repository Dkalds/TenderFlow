"""v117: ``notification_preferences`` — dónde vive «no me mandes esto» (C2.7).
...
revision: str = "v117_notification_preferences"
down_revision: str | Sequence[str] | None = "v116_client_errors"
