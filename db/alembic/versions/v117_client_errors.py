"""v117: ``client_errors`` — lo que falla en el navegador llega a alguien (C2.6, D26).
...
revision: str = "v117_client_errors"
down_revision: str | Sequence[str] | None = "v116_api_keys_organizacion"
