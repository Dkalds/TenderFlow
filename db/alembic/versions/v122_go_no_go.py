"""v122: plantilla de go/no-go ponderada (C6.4, D30).

Revision ID: v122_go_no_go
Revises: v121_pursuit_tasks
...
revision: str = "v122_go_no_go"
down_revision: str | Sequence[str] | None = "v121_pursuit_tasks"
