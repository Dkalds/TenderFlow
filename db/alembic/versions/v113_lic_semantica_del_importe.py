"""v113: el importe dice de qué base es (C1.1, ADR-032, D21).
...
revision: str = "v113_lic_semantica_del_importe"
down_revision: str | Sequence[str] | None = "v112_organization_capabilities"
