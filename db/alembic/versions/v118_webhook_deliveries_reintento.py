"""v118: reintento y re-entrega de webhooks (C2.4).
...
revision: str = "v118_webhook_deliveries_reintento"
down_revision: str | Sequence[str] | None = "v117_notification_preferences"
