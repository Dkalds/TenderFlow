"""v121: ``pursuit_tasks`` — la oportunidad deja de ser una ficha (C6.1).

Revision ID: v121_pursuit_tasks
Revises: v120_asistente_feedback
...
revision: str = "v121_pursuit_tasks"
