"""v114: ``licitaciones.organo_id`` — el órgano deja de ser una cadena (C1.2).

Qué hace
--------
Añade la columna, nullable, con clave foránea a ``organos`` (``v113``). **No
...
revision: str = "v114_lic_organo_id"
down_revision: str | Sequence[str] | None = "v113_organos_master"
