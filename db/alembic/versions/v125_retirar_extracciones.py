"""v125: `extracciones` se retira, con vista de compatibilidad (C4.6).

Revision ID: v125_retirar_extracciones
Revises: v124_notas_y_menciones
...
revision: str = "v125_retirar_extracciones"
down_revision: str | Sequence[str] | None = "v124_notas_y_menciones"
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "'Vista de compatibilidad (C4.6, v125). La tabla real es "
