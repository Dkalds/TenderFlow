...
class TestRollbackMechanics:
    ...
    def test_returns_list_of_reverted_versions(self):
        ...
        # v14, v15, v30, v33 are irreversible; v21-v31 have no ROLLBACKS entry
        # → v34 (job_locks), v32, v20, v19, v18, v17, v16, v13 get rolled back
        assert reverted == [34, 32, 20, 19, 18, 17, 16, 13]
