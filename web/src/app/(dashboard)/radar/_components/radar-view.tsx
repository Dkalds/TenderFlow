...
import { RadarAvisoSenales } from "./radar-aviso-senales";
import { RadarCalidad } from "./radar-calidad";
import { RadarControles } from "./radar-controles";
import { RadarInspectorPanel } from "./radar-inspector-panel";
import { RadarCabecera, RadarLista } from "./radar-lista";
import { RadarPie } from "./radar-pie";
import { RadarProximas } from "./radar-proximas";
 ...
 * envuelve `page.tsx`, en servidor, con el prefetch de las consultas que no
 * dependen de la organización activa (`_lib/prefetch.ts`).
 */
