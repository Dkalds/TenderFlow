...
export async function generateMetadata({
  ...
  return {
    ...
    // Canonical auto-referente incluyendo la página, como los otros hubs.
    alternates: {
      canonical: pagina > 1 ? `${rutaHubOrgano(slug)}?p=${pagina}` : rutaHubOrgano(slug),
    },
    openGraph: {
      ...OG_IMAGE_COMPARTIDA,
      title: titulo,
...
export default async function HubOrgano({
  params,
  searchParams,
}: {
  params: Promise<Params>;
    ...
    <>
      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-12">
        ...
        <p className="text-muted-foreground mt-4 max-w-[62ch] text-base leading-relaxed">
          Concursos públicos con componente de tecnología enterprise publicados por {hub.nombre}. Cada ficha enlaza
          al anuncio original del perfil del contratante.
        </p>
