  ...
  return (
    <article className="mx-auto w-full max-w-4xl px-6 py-12 md:py-16">
      ...
      <header className="mt-10 max-w-3xl">
        ...
        <h1 className="font-display mt-3 text-4xl leading-tight font-bold tracking-normal text-balance md:text-5xl">
          {titulo}
        </h1>
        ...
        {secciones.map((seccion, indice) => (
          ...
          >
            ...
            <div className="max-w-[68ch]">
              <h2 className="font-display text-2xl font-semibold tracking-normal text-balance">{seccion.titulo}</h2>
      ...
      <footer className="border-border/60 mt-4 border-t pt-10">
        <p className="font-display max-w-[34ch] text-2xl font-semibold tracking-normal text-balance">
