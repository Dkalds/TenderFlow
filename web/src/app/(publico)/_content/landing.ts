 ...
 *
 * Al verificar una afirmación, la fuente sigue siendo el código. El README
 * ayuda: su tabla de características ya no da TED por "pendiente de cablear"
 * —lo declara activo cada cuatro horas, que es lo que hace
 * `.github/workflows/scrape-daily.yml` pese a llamarse "daily"—, así que esta
 * cabecera dejó de advertir contra él el 2026-09-06 (O0.7c del plan de
 * arquitectura v2).
 */
