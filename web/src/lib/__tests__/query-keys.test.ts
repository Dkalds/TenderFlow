...
const FABRICAS: readonly Fabrica[] = [
  ...
  },
  {
    ...
    miembros: [
      ...
      { nombre: "analyticsKeys.desdeUltimaVisita", clave: analyticsKeys.desdeUltimaVisita(21) },
    ],
  },
  {
    nombre: "radarKeys",
  ...
  },
  {
    nombre: "searchKeys",
    raiz: searchKeys.all,
    miembros: [{ nombre: "searchKeys.global", clave: searchKeys.global("indra", 21) }],
  },
  {
    nombre: "pursuitKeys",
  ...
  },
  {
    ...
    raiz: cuentaKeys.all,
    miembros: [
      { nombre: "cuentaKeys.lista", clave: cuentaKeys.lista(21) },
      { nombre: "cuentaKeys.resumen", clave: cuentaKeys.resumen(21) },
      { nombre: "cuentaKeys.ficha", clave: cuentaKeys.ficha(21, 7) },
      { nombre: "cuentaKeys.deOrgano", clave: cuentaKeys.deOrgano(21, "Ayuntamiento de Soria") },
      { nombre: "cuentaKeys.buscarOrganos", clave: cuentaKeys.buscarOrganos(21, "soria") },
    ],
  },
  {
    nombre: "etiquetaKeys",
  ...
  {
    nombre: "simuladorKeys",
    raiz: simuladorKeys.all,
    miembros: [
      { nombre: "simuladorKeys.detail", clave: simuladorKeys.detail("LIC-1", [0.12], 0.18) },
    ],
  },
  {
    nombre: "paginaKeys",
    raiz: paginaKeys.all,
    miembros: [{ nombre: "paginaKeys.detail", clave: paginaKeys.detail("LIC-1", 7, 3, 10, 20) }],
  },
  {
    nombre: "guionKeys",
    raiz: guionKeys.all,
    miembros: [{ nombre: "guionKeys.detail", clave: guionKeys.detail("LIC-1") }],
  },
  {
    nombre: "comparacionKeys",
    raiz: comparacionKeys.all,
    miembros: [{ nombre: "comparacionKeys.fichas", clave: comparacionKeys.fichas(["A", "B"]) }],
  },
  {
...
describe("las fábricas parametrizadas", () => {
  ...
  const PARAMETRIZADAS: ReadonlyArray<{
    ...
    { nombre: "cuentaKeys.resumen", conA: () => cuentaKeys.resumen(21), conB: () => cuentaKeys.resumen(22) },
    { nombre: "cuentaKeys.ficha", conA: () => cuentaKeys.ficha(21, 7), conB: () => cuentaKeys.ficha(21, 8) },
    // La organización discrimina tanto como el órgano: el mismo órgano puede
    // ser cuenta de un equipo y no de otro, y el botón no puede heredar el estado.
    { nombre: "cuentaKeys.deOrgano", conA: () => cuentaKeys.deOrgano(21, "Ayuntamiento de Soria"), conB: () => cuentaKeys.deOrgano(22, "Ayuntamiento de Soria") },
    { nombre: "cuentaKeys.buscarOrganos", conA: () => cuentaKeys.buscarOrganos(21, "soria"), conB: () => cuentaKeys.buscarOrganos(21, "segovia") },
