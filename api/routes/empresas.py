...
async def empresas_stats(_ctx: dict[str, Any] = Depends(require_any_auth)) -> dict[str, Any]:
    """% de adjudicaciones (filas e importe) resueltas a empresa canónica."""
    return await run_db(resolution_stats)
...
async def resolve_review(
    ...
    return {"status": "ok", "review_id": review_id, "empresa_id": empresa_id}
